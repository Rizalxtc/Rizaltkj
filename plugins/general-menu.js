...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await genProfile(conn, m), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']],m, { viewOnce: true })
...
async function genProfile(conn, m) {
  let font = await jimp.loadFont('./names.fnt'),
    ...
    avatar = await jimp.read(await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://telegra.ph/file/2515470b061e83b280440.png')),
